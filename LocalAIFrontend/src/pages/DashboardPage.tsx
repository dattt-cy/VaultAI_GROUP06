...
import { Plus, Book, MoreVertical, Trash2, Bot, LogOut, MessageSquare } from 'lucide-react';
      ...
      <main className="flex-1 overflow-y-auto">        
        ...
        <div className="flex justify-between items-end mb-6">
          <div>
            ...
            <p className="text-[13px] text-text-muted mt-0.5">Mỗi cuộc trò chuyện là một sổ ghi chú</p>
          </div>
        </div>
            ...
            >
              ...
              <div className="p-4 flex-1 flex flex-col">
                <div className="flex justify-between items-start mb-2">
                  ...
                  {menuOpen === nb.id && (
                    <div
                      className="absolute top-12 right-3 z-20 bg-surface border border-border rounded-xl shadow-xl py-1 min-w-[140px]"
